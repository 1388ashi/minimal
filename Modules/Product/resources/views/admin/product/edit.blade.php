                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="image_alt" id="image_alt"
                                               placeholder="آلت تصویر محصول اینجا وارد کنید" value="{{ old('image_alt',$product->image_alt) }}"
                                                autofocus>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="canonical_tag" id="canonical_tag"
                                               placeholder="تگ کنونیکال محصول اینجا وارد کنید" value="{{ old('canonical_tag',$product->canonical_tag) }}"
                                                autofocus>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="title_page" id="title_page"
                                               placeholder="عنوان صفحه محصول اینجا وارد کنید" value="{{ old('title_page',$product->title_page) }}"
                                                autofocus>
                                    </div>
                                </div>
                                <div class="col-md-8">
                                    <div class="form-group">
                                        ...
                                        <textarea name="meta_description"  class="form-control" id="">{{ old('meta_description',$product->meta_description) }}</textarea>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
