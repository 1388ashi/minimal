...
@section('content')
    ...
    <div class="page-header">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page"><a href="{{ route('admin.brand-sliders.index') }}">لیست اسلایدر ها</a></li>
        ...
        <div class="col-md">
            <div class="card overflow-hidden">
                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('admin.brand-sliders.update',$slider) }}" method="post" enctype="multipart/form-data">
                        @csrf
                        @method('PATCH')
