    ...
    <div class="page-header mx-5">
        ...
        <div class="mt-3">
            <div class="d-flex align-items-center flex-wrap text-nowrap">
                @can('create sliders')
                <a href="{{ route('admin.brand-sliders.create') }}" class="btn btn-indigo">
                    ثبت اسلایدر جدید
        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header border-0">
                    <div class="card-title">لیست همه اسلایدر های صفحه برند ({{ $sliders->total() }})</div>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    {{-- Edit--}}
                                    @can('edit sliders')
                                    <a href="{{ route('admin.brand-sliders.edit', [$slider->id]) }}" class="btn btn-warning btn-sm text-white" data-toggle="tooltip" data-original-title="ویرایش"><i class="fa fa-pencil"></i></a>
                                    @endcan
                                    {{-- Delete--}}
                                    @can('delete sliders')
                                    <x-core::delete-btn route="admin.brand-sliders.destroy" :model="$slider" :disabled="false" />
                                    @endcan
                                    </td>
                            </tr>
                                    @empty
